...
void IRLESLabel(Double_t x,Double_t y,char* text,Color_t color)
{
...
void IRLESLabel_ratio(Double_t x,Double_t y,char* text,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void IRLESLabelOld(Double_t x,Double_t y,bool Preliminary,Color_t color) 
{
  TLatex l; //l.SetTextAlign(12); l.SetTextSize(tsize); 
  l.SetNDC();
  l.SetTextFont(72);
...
void IRLESVersion(char* version,Double_t x,Double_t y,Color_t color) 
{
