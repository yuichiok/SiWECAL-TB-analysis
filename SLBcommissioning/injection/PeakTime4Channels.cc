...
void PeakTime4Channels(TString filename_in="/home/calice/TB2020/commissioning/SiWECAL-TB-analysis_TB2020/converter_SLB/convertedfiles/", TString run="20200226_dac1.15V_chn0to3_hold80_Ascii", int nslboards=6, int channel1=0, int channel2=8, int channel3=16, int channel4=24){
  ...
  for(int i=0; i<4; i++) {
    ...
    if(i==2) pt="90ns";
    if(i==3) pt="120ns";
      TString filename=filename_in+TString::Format("%s/FSpeakTime%s.root",run.Data(),pt.Data());
    cout<<" Holdscan file: "<<filename_in<<endl;
